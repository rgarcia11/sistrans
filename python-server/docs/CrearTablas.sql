...
PRIMARY KEY(idAvion),
CONSTRAINT ck_marca CHECK(marca IN ('Airbus','Boeing','Bombardier','Embraer','Tupoloev', 'Cessna', 'Cirrus Design', 'Diamond', 'Mooney', 'Piper')),
CHECK(numSerie>0),
...
BEGIN
FOR x IN (SELECT 'GRANT ALL ON '||table_name||' TO ISIS2304B081620' AS stmt FROM user_tables)
LOOP
